package com.api.forticom//.SignUtil 
{
	...
	public class SignUtil
	{
		...
		public static function signRequest(data : Object, exception : Boolean = false, format : String = "XML") : Object
		{
			data["format"] = format;
			...
			//sig += (data['uid'] != undefined && !exception) ? SignUtil.secretKey : SignUtil.secretSessionKey;
			sig += SignUtil.secretSessionKey;
